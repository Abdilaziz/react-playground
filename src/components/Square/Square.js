...
// constructor(props) {
// all JavaScripts classes you should use super in the 
...
//       // AKA not passing a function, would fire the alert event every 
//  time the component re-renders
//       // now react will re-render the square whenever the its button is 
// clicked
//       // after the update the state will be 'X'
//       // Note: when you call setState in a component, React auto updates 
